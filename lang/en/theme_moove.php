...
$string['loginlogo_desc'] = 'Upload a custom logo for the login form.';
$string['loginlogobg'] = 'Login logo background';
$string['loginlogobg_desc'] = 'Upload a custom background image for the login logo column.';
$string['loginlogotext'] = 'Login logo text';
$string['loginlogotext_desc'] = 'Text displayed below the logo on the login form.';
...
$string['slidesubtitledesc'] = 'Add a subtitle for your slide. This will display as secondary text below the main title (usually in white color).';

// 🆕 Số lượng boxes
$string['sliderboxcount'] = 'Number of boxes';
$string['sliderboxcountdesc'] = 'Select how many boxes you want to add to this slide <strong>then click SAVE</strong> to load the input fields. Leave 0 if you don\'t want boxes.';

// 🆕 Box fields
$string['sliderboximage'] = 'Box {$a} image';
$string['sliderboximagedesc'] = 'Add an image for this box. Recommended size is 400px x 250px.';
$string['sliderboxtitle'] = 'Box {$a} title';
$string['sliderboxdesc'] = 'Add a title for this box.';
$string['sliderboxbuttontext'] = 'Box {$a} button text';
$string['sliderboxbuttontextdesc'] = 'Add button text for this box (e.g. "Learn More", "Enroll Now").';
$string['sliderboxbuttonlink'] = 'Box {$a} button link';
$string['sliderboxbuttonlinkdesc'] = 'Add the URL link for the button.';

// 🆕 Center logo for slide
$string['slidercenterlogo'] = 'Center logo for slide {$a}';
$string['slidercenterlogodesc'] = 'Upload an image to display between the boxes for this slide. Recommended size is 120px x 120px.';
